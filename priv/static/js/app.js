...
console.log("Hello world from assets"); // webpack automatically bundles all modules in your
...
let liveSocket = new phoenix_live_view__WEBPACK_IMPORTED_MODULE_4__["LiveSocket"]("/live", phoenix__WEBPACK_IMPORTED_MODULE_2__["Socket"], {
  params: {
    _csrf_token: csrfToken
  }
}); // Show progress bar on live navigation and form submits

window.addEventListener("phx:page-loading-start", info => nprogress__WEBPACK_IMPORTED_MODULE_3___default.a.start());
window.addEventListener("phx:page-loading-stop", info => nprogress__WEBPACK_IMPORTED_MODULE_3___default.a.done()); // connect if there are any LiveViews on the page
